<!-- https://github.com/vuejs/vuepress/blob/master/packages/%40vuepress/theme-default/global-components/CodeGroup.vue -->
<!-- TODO original component does not work when ssr is enabled & first loading the page. Don't know why... -->
<template>
