...
import { AspectOptions } from '../annotations/aspect/aspect.annotation';
...
function __getAspectOptions(aspect: AspectType | Function): AspectOptions {
    if (!aspect) {
        return;
    }
    const proto = getProto(aspect);
 ...
 * @public
 */
export function _getAspectOptions(aspect: AspectType | Function): AspectOptions {
 ...
 * @public
 */
export function _setAspectOptions(target: Function, options: AspectOptions) {
