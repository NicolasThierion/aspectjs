...
describe('RootAnnotationsBundle', () => {
    ...
    beforeEach(() => {
        rootBundle = WEAVER_CONTEXT.annotations.bundle;
    });
    ...
    describe('.at(classLocation)', () => {
        function emptyClassBundle() {
            return rootBundle.at(WEAVER_CONTEXT.annotations.location.of(Empty));
        }

        function abcdClassBundle() {
            return rootBundle.at(WEAVER_CONTEXT.annotations.location.of(abcd));
        }

        function xClassBundle() {
            return rootBundle.at(WEAVER_CONTEXT.annotations.location.of(x));
        }
        describe('.all()', () => {
    ...
    describe('.at(propertyLocation)', () => {
        function emptyPropertyBundle() {
            return rootBundle.at(WEAVER_CONTEXT.annotations.location.of(Empty).somePropAB);
        }

        function abPropertyBundle() {
            return rootBundle.at(WEAVER_CONTEXT.annotations.location.of(abcd).somePropAB);
        }
        describe('.all()', () => {
            describe('when located property uses no annotation', () => {
                it('should return an empty array', () => {
    ...
    describe('.at(methodLocation)', () => {
        function emptyMethodBundle() {
            return rootBundle.at(WEAVER_CONTEXT.annotations.location.of(Empty).someMethodAB);
        }

        function abMethodBundle() {
            return rootBundle.at(WEAVER_CONTEXT.annotations.location.of(abcd).someMethodAB);
        }
        describe('.all()', () => {
    ...
    describe('.at(parametersLocation)', () => {
        function emptyParametersBundle() {
            return rootBundle.at(WEAVER_CONTEXT.annotations.location.of(Empty).someMethodAB?.args);
        }

        function abParametersBundle() {
            return rootBundle.at(WEAVER_CONTEXT.annotations.location.of(abcd).someMethodAB.args);
        }
        describe('.all()', () => {
    ...
    describe('.at(parametersLocation[i])', () => {
        function emptyParametersBundle() {
            return rootBundle.at(WEAVER_CONTEXT.annotations.location.of(Empty).someMethodAB?.args[0]);
        }

        function abParametersBundle() {
            return rootBundle.at(WEAVER_CONTEXT.annotations.location.of(abcd).someMethodAB.args[0]);
        }
        describe('.all()', () => {
